...
export type ModelTypes = {
    ["Date"]:any;
	["Mutation"]: {
		createUser?:ModelTypes["CurrentUser"],
	...
	setConfirmed?:ModelTypes["Transaction"]
};
	["Query"]: {
...
export type GraphQLTypes = {
	...
	["Mutation"]: {
	__typename: "Mutation",
	createUser?: GraphQLTypes["CurrentUser"],
	changeWebhook?: string,
	regenerateApiKey?: string,
	setFast?: boolean,
	setPublicKey?: string,
	...
	setConfirmed?: GraphQLTypes["Transaction"]
};
	["Query"]: {
	__typename: "Query",
...
export const enum TransactionFilter {
	All = "All",
	Pending = "Pending",
	Confirmed = "Confirmed"
}
